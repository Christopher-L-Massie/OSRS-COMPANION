...
public enum dataNames {
    ...
    MIMIC("Mimic",5,61),
    NIGHTMARE("Nightmare",5,62),
    OBOR("Obor",5,63),
    SARACHNIS("Sarachnis",5,64),
    SCORPIA("Scorpia",5,65),
    SKOTIZO("Skotizo",5,66),
    THE_GAUNTLET("The Gauntlet",5,67),
    THE_CORRUPTED_GAUNTLET("The Corrupted Gauntlet",5,68),
    THEATRE_OF_BLOOD("Theatre of Blood",5,69),
    THERMONUCLEAR_SMOKE_DEVIL("Thermonuclear Smoke Devil",34,70),
    TZKAL_ZUK("TzKal-Zuk",5,71),
    TZTOK_JAD("TzTok-Jad",5,72),
    VENENATIS("Venenatis",5,73),
    VETION("Vet'ion",5,74),
    VORKATH("Vorkath",5,75),
    WINTERTODT("Wintertodt",5,76),
    ZALCANO("Zalcano",5,77),
    ZULRAH("Zulrah",5,78);
